...
Read all files in `src/content/contacts/`.
...
Write the file to `src/content/contacts/{slug}.md`
using the template format from `.templates/contact.md`. Fill in all provided fields.
