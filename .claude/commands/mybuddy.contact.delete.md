...
Read `src/content/contacts/{slug}.md`. If not found, inform the user.
...
If confirmed, delete the file at `src/content/contacts/{slug}.md`.

### 4. Output

```text
{PERSONA NAME} | Deleted contact: src/content/contacts/{slug}.md
```
