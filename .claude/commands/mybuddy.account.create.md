...
Read all files in `src/content/accounts/`.
...
Write the file to `src/content/accounts/{slug}.md`
using the template format from `.templates/account.md`. Fill in all provided fields.
