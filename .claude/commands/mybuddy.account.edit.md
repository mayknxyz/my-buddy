---
description: Edit an account entry.
---
...
Read `src/content/accounts/{slug}.md`. If not found, try fuzzy matching.
...
```text
{PERSONA NAME} | Updated account: src/content/accounts/{slug}.md
