---
description: Delete a meeting entry.
---
...
Read `src/content/meetings/{slug}.md`. If not found, inform the user.
...
If confirmed, delete the file at `src/content/meetings/{slug}.md`.

### 4. Output

```text
{PERSONA NAME} | Deleted meeting: src/content/meetings/{slug}.md
```
