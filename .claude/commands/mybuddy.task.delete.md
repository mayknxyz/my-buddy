...
Read `src/content/tasks/{slug}.md`. If not found, inform the user.
...
If confirmed, delete the file at `src/content/tasks/{slug}.md`.

### 4. Output

```text
{PERSONA NAME} | Deleted task: src/content/tasks/{slug}.md
```
