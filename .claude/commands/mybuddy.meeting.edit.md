---
description: Edit a meeting entry.
---
...
Read `src/content/meetings/{slug}.md`. If not found, try fuzzy matching.
...
```text
{PERSONA NAME} | Updated meeting: src/content/meetings/{slug}.md
