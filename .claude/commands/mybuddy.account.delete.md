---
description: Delete an account entry.
---
...
Read `src/content/accounts/{slug}.md`. If not found, inform the user.
...
If confirmed, delete the file at `src/content/accounts/{slug}.md`.
