---
description: Edit a contact entry.
---
...
Read `src/content/contacts/{slug}.md`. If not found, try fuzzy matching.
...
```text
{PERSONA NAME} | Updated contact: src/content/contacts/{slug}.md
